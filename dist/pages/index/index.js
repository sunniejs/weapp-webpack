...
var merge = __webpack_require__(/*! webpack-merge */ "../node_modules/webpack-merge/lib/index.js");

var config = __webpack_require__(/*! ./env.development */ "./config/env.development.js");

var weappConfig = merge(config, {
...
/* harmony import */ var _utils_util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/utils/util.js */ "./utils/util.js");
 ...
 * @param {Function}} 回调方法
 */
var toast = function toast(title, icon, fn) {
  wx.showToast({
    title: title,
    icon: icon || 'none',
    duration: 2000,
